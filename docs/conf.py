...
# documentation.
html_theme_options = dict(github_fork="jamiejackherer/quart-login", index_logo=False)
...
man_pages = [
    ("index", "quart-login", "Quart-Login Documentation", ["Jamie Lindsey"], 1)
]
